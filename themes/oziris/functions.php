...
*/
	...
	add_image_size('partner-thumb',353,200,true);
}
endif;
...
function oziris_scripts() {
	...
	$themes_version = '1.6.0';
	
	// LOAD GOOGLE FONT
	wp_enqueue_style( 'google-font','https://fonts.googleapis.com/css?family=Open+Sans:400italic,300italic,600italic,400,300,600,700|Lato:400,700,900|Roboto:700' );
	...
	wp_enqueue_style( 'oziris-style', get_stylesheet_uri(),'', $themes_version);
	...
	wp_localize_script( 'oziris-single', 'loadmore', array(
	...
	if(is_front_page() && 'page' == get_option( 'show_on_front' )){
		...
		wp_enqueue_style( 'oziris-style-home', get_template_directory_uri() . '/style-home.css','',$themes_version );
		
		
		wp_enqueue_script( 'oziris-skrollr', get_template_directory_uri() . '/js/skrollr.min.js', array(), $themes_version, true );
		wp_enqueue_script( 'oziris-plugins', get_template_directory_uri() . '/js/plugins.js', array('jquery'), $themes_version, true );
		wp_enqueue_script( 'oziris-main', get_template_directory_uri() . '/js/main.js', array('jquery'), $themes_version, true );
	
	}else{
		wp_enqueue_script( 'oziris-main-2', get_template_directory_uri() . '/js/main-2.js', array('jquery'), $themes_version, true );
	}
...
require get_template_directory() . '/inc/function-white-label.php';
