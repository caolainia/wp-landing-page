...
<div id="primary" class="content-area content-page content-blog">
	<main id="main" class="site-main" role="main">
		...
		<?php
			$loop_1 = new WP_Query(array('post_type'=>'post','posts_per_page'=>1));
		?>
		<div class="container">
			<div class="row">
				...
				<div class="third-section clearfix section-blog">
					<div class="col-md-12  col-sm-12 col-xs-12">
						<?php
						$promo_image = get_field('promo_image',get_option('page_for_posts'));
						$promo_link = get_field('promo_link',get_option('page_for_posts'));
						
						if($promo_link){
							echo '<a href="'.$promo_link.'">';
						}
						if($promo_image){
							echo '<img src="'.$promo_image['url'].'" width="'.$promo_image['width'].'" height="'.$promo_image['height'].'" alt="" />';
						}
						if($promo_link){
							echo '</a>';
						}
				...
				<div class="fourth-section clearfix section-blog">
					...
					foreach($items as $item => $val){
						...
						if($insta_img_url){
							echo '<li class="col-md-6 col-sm-3 col-xs-6"><a href="'.$insta_img_link.'" target="_blank"><img src="'.$insta_img_url.'" width="150" height="150" alt="" /></a></li>';
						}
					...
					<div class="col-md-9">
						<div class="inner-see-also">
							<h3 class="underline">Older News</h3>
							<div class="also-post">
							...
							<div class="load-more"><a data-offset="200" data-paging="0"></a></div>
							<div class="loader">
				<div></div>
				<div></div>
				<div></div>
