...
function oziris_scripts() {
	...
	wp_enqueue_style( 'google-font','http://fonts.googleapis.com/css?family=Open+Sans:400italic,300italic,600italic,400,300,600,700|Lato:900|Roboto:700' );
	...
	if(is_front_page() && 'page' == get_option( 'show_on_front' )){
		...
		wp_enqueue_style( 'oziris-style-home', get_template_directory_uri() . '/style-home.css' );
		...
		wp_enqueue_script( 'oziris-main', get_template_directory_uri() . '/js/main.js', array('jquery'), '1.1', true );
	}
}
