...
<section id="welcome-video">
	<video id="movie" poster="<?php bloginfo('template_url') ?>/img/scene-1-bg.jpg" preload="auto" autoplay loop>
...
<div class="the-hand">
			...
			<div class="content"
				...
				<div class="cta"
					data-_scene1-1050p="transform:translate(0,100%)"
					data-_scene1-1300p="transform:translate(0,0%)"><a href="<?php echo get_post_meta($id,'sign_up_link',true); ?>" class="ease"><?php echo get_post_meta($id,'sign_up_text',true); ?></a></div>
		...
		<div class="scroll-trigger"><img src="<?php bloginfo('template_url')?>/img/scroll-down.png" width="44" height="26" alt="" /></div>
...
data-_scene1-951p="transform:translate(0,0%);top:0%;z-index:101">
	...
	<div class="scene6 background-cover" 
			...
			<div class="finish-cta"><a href="<?php echo get_post_meta($id,'sign_up_link',true); ?>" class="ease"><?php echo get_post_meta($id,'sign_up_text',true); ?></a></div>
